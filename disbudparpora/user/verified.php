                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive" style="overflow-x:hidden;">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="tempatlahir" type="text" class="form-control" maxlength="50" value="<?php echo $ambil['tempatlahir']?>" disabled>
                                            </div>
                                            </div>
                                            <div class="col">
                                            <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                <label>Alamat</label>
                                                <input name="alamat" type="text" class="form-control" maxlength="20" value="<?php echo $ambil['alamat']?>" disabled>
                                            </div>
                                            </div>
                                            <div class="col">
                                            <div class="form-group">
                                            <label>Kelurahan</label>
                                                <input type="text" class="form-control" value="<?php echo $ambil['kelurahan']?>" disabled>
                                            </div>
                                            </div>
                                        </div>
                                            <div class="form-group">
                                            <label>Kecamatan</label>
                                                <input type="text" class="form-control" value="<?php echo $ambil['kecamatan']?>" disabled>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                            <label>No Hp</label>
                                                <input name="nohp" type="text" class="form-control" maxlength="15" value="<?php echo $ambil['nohp']?>" disabled>
                                        </div>
                                        </div>
                                        <div class="col">
                                        <div class="form-group">
                                        <label>Jabatan</label>
                                                <input name="jabatan" type="text" class="form-control" maxlength="15" value="<?php echo $ambil['jabatan']?>" disabled>
                                        </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <label>Nama Kesenian</label>
                                                <input name="namakesenian" type="text" class="form-control" maxlength="15" value="<?php echo $ambil['namakesenian']?>" disabled>
                                        </div>
                                        </div>
                                        <div class="col">
                                        <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="<?php echo $ambil['jeniskesenian']?>" disabled>
                                            </div>
                                            </div>
                                            <div class="col">
                                            <div class="form-group">
                                                <label>Jumlah Anggota</label>
                                                <input name="jmlanggota" type="text" class="form-control" maxlength="15" value="<?php echo $ambil['jmlanggota']?>" disabled>
                                            </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                        ...
                                                        <img src="<?php echo $ambil['ktpketua']?>" width="50%">
                                                    </div>
                                                </div>
                                            <div class="col">
                                                <div class="form-group">
                                                        <label for="ktpanggota" class=" form-control-label">KTP Anggota(JPG/PNG), maks 500kb</label>
                                                        <img src="<?php echo $ambil['ktpanggota']?>" width="50%">
                                                </div>
                                            </div>
                                        </div>
