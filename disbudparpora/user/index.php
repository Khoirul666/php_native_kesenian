                            ...
                            <div class="card-body">
                               ...
                               <div class="market-status-table mt-4">
                                <div class="table-responsive">
                                 ...
                                 <br>2. Isi seluruh data dan berkas yang yang ditampilkan kemudian periksa kembali, pastikan data tidak ada yang salah
                                 <br>3. Klik simpan, kemudian confirm. Setelah data diconfirm, data tidak dapat diubah kembali
                                 <br>4. Jika sudah, bukti pendaftaran akan tampil dan dapat diunduh menjadi pdf
                                 <br>
