...
if(isset($_POST['dataubah'])){
    $no_induk = $_POST['no_induk'];
    $id = $_POST['dataubah'];
    $update = mysqli_query($conn,"update userdata set noinduk='".$no_induk."' where userdataid='".$id."'");
    if($update){
            //berhasil bikin
        echo "
        <div class='alert alert-success'>
        Berhasil ubah data no Induk.
        </div>
        ...
        Gagal ubah data no Induk. Silakan coba lagi nanti.
        </div>
                                ...
                                <tbody>
                                    ...
                                    while($b=mysqli_fetch_array($form)){
                                        ...
                                        <tr>
                                            ...
                                            <div id="no_induk<?= $b['userdataid'] ?>" class="modal fade">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title">No Induk</h4>
                                                        </div>
                                                        <form method="post">
                                                            <div class="modal-body">
                                                                <div class="form-group">
                                                                    <label>No Induk</label>
                                                                    <input name="no_induk" type="text" class="form-control" placeholder="No Induk" value="<?= $b['noinduk'] ?>">
                                                                </div>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
                                                                <button type="submit" class="btn btn-primary" value="<?= $b['userdataid'] ?>" name="dataubah">Ubah</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
