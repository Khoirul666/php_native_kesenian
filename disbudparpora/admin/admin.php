...
if(isset($_POST['adminubah'])){
    ...
    $password = $_POST['adminpassword'];
    $id = $_POST['adminubah'];
    $update = mysqli_query($conn,"update admin set adminemail='".$email."', adminpassword='".$password."' where adminid='".$id."'");
    if($update){
            //berhasil bikin
        echo "
        <div class='alert alert-success'>
        Berhasil ubah data admin.
        </div>
        <meta http-equiv='refresh' content='1; url= admin.php'/>";  
    } 
    else {
        echo "
        <div class='alert alert-warning'>
        Gagal ubah data admin. Silakan coba lagi nanti.
        </div>
        <meta http-equiv='refresh' content='3; url= admin.php'/> ";
    }
};
                                    ...
                                    <tbody>
                                        ...
                                        while($b=mysqli_fetch_array($form)){
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-sm-flex">
                                                        <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#edit<?= $b['adminid'] ?>">Edit</button>
                                                        <form method="post">
                                                ...
                                                <div id="edit<?= $b['adminid'] ?>" class="modal fade">
                                                            ...
                                                            <form method="post">
                                                                <div class="modal-body">
                                                                    <div class="form-group">
                                                                        <label>Email</label>
                                                                        <input name="adminemail" type="email" class="form-control" placeholder="Email" value="<?= $b['adminemail'] ?>">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label>Password</label>
                                                                        <input name="adminpassword" type="password" class="form-control" placeholder="Password" value="<?= $b['adminpassword'] ?>">
                                                                    </div>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
                                                                    <button type="submit" class="btn btn-primary" value="<?= $b['adminid'] ?>" name="adminubah">Ubah</button>
                                                                </div>
                                                            </form>
                                                        </div>
                                                    </div>
